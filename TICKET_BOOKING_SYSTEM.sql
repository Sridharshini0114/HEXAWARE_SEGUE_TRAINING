...
--INSERTING A VALUES
INSERT INTO Venu  VALUES ('tickettitans', 'bangalore')
INSERT INTO Venu  VALUES ('ArenaOne', 'Mumbai')
INSERT INTO Venu VALUES ('StadiumX', 'Delhi')
INSERT INTO Venu  VALUES ('ConcertHub', 'Chennai')
INSERT INTO Venu  VALUES ('CinemaWorld', 'Hyderabad')
INSERT INTO Venu  VALUES ('SportsArena', 'Pune')
INSERT INTO Venu  VALUES ('MegaEventCenter', 'Kolkata')
INSERT INTO Venu  VALUES ('OpenAirPark', 'Bangalore')
INSERT INTO Venu  VALUES ('MusicPlaza', 'Ahmedabad')
INSERT INTO Venu  VALUES ('TheaterTown', 'Jaipur')
INSERT INTO Venu  VALUES ('TheaterTown', 'italy')
...
('MovieNight', '2024-02-01', '18:00:00', 1, 150, 120, 150, 'Movie'),
('RockConcert', '2024-03-15', '20:00:00', 2, 200, 180, 250, 'Concert'),
('CricketMatch', '2024-04-05', '14:30:00', 3, 50000, 49000, 500, 'Sports'),
('ComedyShow', '2024-05-10', '19:00:00', 4, 300, 250, 120, 'Concert'),
('FootballGame', '2024-06-20', '16:00:00', 5, 40000, 38000, 400, 'Sports'),
('DramaPlay', '2024-07-25', '17:30:00', 6, 250, 200, 80, 'Movie'),
('ClassicalConcert', '2024-08-10', '19:30:00', 7, 150, 100, 200, 'Concert'),
('BasketballGame', '2024-09-18', '18:00:00', 8, 10000, 9000, 300, 'Sports'),
('OperaNight', '2024-10-12', '20:30:00', 9, 100, 80, 400, 'Concert'),
('nightconcert','2023-09-08','16:00:00',10,28,10,900,'movie')
...
INSERT INTO CUSTOMER_TABLE VALUES('varshi','varshi@gmail.com',792734)
...
CREATE TABLE Booking_Table (
	...
	INSERT INTO Booking_Table VALUES(1,1,400,1000,'2022-09-10')
	INSERT INTO Booking_Table VALUES(2,2,600,2000,'2023-09-11')
	INSERT INTO Booking_Table VALUES(3,3,1000,950,'2024-09-1')
	INSERT INTO Booking_Table VALUES(4,4,1200,800,'2024-09-10')
	INSERT INTO Booking_Table VALUES(5,5,1300,250,'2023-08-11')
	INSERT INTO Booking_Table VALUES(6,6,400,300,'2022-07-15')
...
SELECT b.event_id,e.event_name,
...
FROM (
    SELECT Event.event_type, Booking_table.num_tickets AS total_tickets_sold
    FROM Booking_table
    JOIN Event ON Booking_table.event_id = Event.event_id
) AS EventTickets
GROUP BY event_type;
